...
var admin = builder.AddProject<Projects.BingoBoard_Admin>("boardadmin")
    ...
    .WithEnvironment("DOTNET_VERSION", builder.Configuration["DOTNET_VERSION"] ?? Environment.GetEnvironmentVariable("DOTNET_VERSION") ?? "9.0")
    .WithEnvironment("ASPIRE_VERSION", builder.Configuration["ASPIRE_VERSION"] ?? Environment.GetEnvironmentVariable("ASPIRE_VERSION") ?? "13.0.0")
